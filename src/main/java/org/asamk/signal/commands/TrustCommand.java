...
public class TrustCommand implements LocalCommand {
	...
	public void attachToSubparser(final Subparser subparser) {
		...
		mutTrust.addArgument("-a", "--trust-all-known-keys")
				.help("Trust all known keys of this user, only use this for testing.").action(Arguments.storeTrue());
		mutTrust.addArgument("-v", "--verified-safety-number", "--verified-fingerprint").help(
