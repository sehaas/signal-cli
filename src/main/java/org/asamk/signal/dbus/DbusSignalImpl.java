...
public class DbusSignalImpl implements Signal {
	...
	public long sendGroupMessage(final String message, final List<String> attachments, final byte[] groupId) {
		try {
			Pair<Long, List<SendMessageResult>> results = m.sendGroupMessage(message, attachments,
	...
	public byte[] updateGroup(byte[] groupId, String name, List<String> members, String avatar) {
		try {
			...
			final Pair<GroupId, List<SendMessageResult>> results = m
					.updateGroup(groupId == null ? null : GroupId.unknownVersion(groupId), name, members, avatar);
