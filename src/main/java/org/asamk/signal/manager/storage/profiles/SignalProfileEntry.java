...
public class SignalProfileEntry {
	...
	public SignalProfileEntry(final SignalServiceAddress serviceAddress, final ProfileKey profileKey,
			final long lastUpdateTimestamp, final SignalProfile profile,
