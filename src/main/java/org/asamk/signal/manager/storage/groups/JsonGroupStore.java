...
public class JsonGroupStore {
	...
	private static class GroupsSerializer extends JsonSerializer<Map<String, GroupInfo>> {
		...
		@Override
		public void serialize(final Map<String, GroupInfo> value, final JsonGenerator jgen,
	...
	private static class GroupsDeserializer extends JsonDeserializer<Map<GroupId, GroupInfo>> {
		...
		@Override
		public Map<GroupId, GroupInfo> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
				throws IOException {
