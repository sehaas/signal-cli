...
public class GroupInfoV1 extends GroupInfo {
	...
	public GroupInfoV1(@JsonProperty("groupId") byte[] groupId, @JsonProperty("expectedV2Id") byte[] expectedV2Id,
			@JsonProperty("name") String name, @JsonProperty("members") Collection<SignalServiceAddress> members,
			@JsonProperty("avatarId") long _ignored_avatarId, @JsonProperty("color") String color,
			@JsonProperty("blocked") boolean blocked, @JsonProperty("inboxPosition") Integer inboxPosition,
	...
	private static class MembersSerializer extends JsonSerializer<Set<SignalServiceAddress>> {
		...
		@Override
		public void serialize(final Set<SignalServiceAddress> value, final JsonGenerator jgen,
	...
	private static class MembersDeserializer extends JsonDeserializer<Set<SignalServiceAddress>> {
		...
		@Override
		public Set<SignalServiceAddress> deserialize(JsonParser jsonParser,
