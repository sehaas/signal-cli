...
public class ServiceConfig {
	...
	final static byte[] KEY_BACKUP_SERVICE_ID = Hex
			.decode("fe7c1bfae98f9b073d220366ea31163ee82f6d04bead774f71ca8e5c40847bfe");
	...
	private final static byte[] zkGroupServerPublicParams = Base64.getDecoder().decode(
	...
	public static SignalServiceConfiguration createDefaultServiceConfiguration(String userAgent) {
		...
		return new SignalServiceConfiguration(new SignalServiceUrl[] { new SignalServiceUrl(URL, TRUST_STORE) },
				...
				new SignalStorageUrl[] { new SignalStorageUrl(STORAGE_URL, TRUST_STORE) }, interceptors, dns,
	...
	private static Map<Integer, SignalCdnUrl[]> makeSignalCdnUrlMapFor(SignalCdnUrl[] cdn0Urls,
			SignalCdnUrl[] cdn2Urls) {
